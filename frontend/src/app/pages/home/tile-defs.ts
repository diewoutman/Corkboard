...
export const TILE_DEFS: TileDef[] = [
  {
    key: 'tasks',
    titleKey: 'tiles.tasks.title',
    descriptionKey: 'tiles.tasks.description',
    route: '/tasks',
    icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z',
  },
  {
    key: 'notes',
    titleKey: 'tiles.notes.title',
    descriptionKey: 'tiles.notes.description',
    route: '/notes',
    icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z',
  },
  {
    key: 'calendar',
    titleKey: 'tiles.calendar.title',
    descriptionKey: 'tiles.calendar.description',
    route: '/calendar',
    icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z',
  },
  {
    key: 'contacts',
    titleKey: 'tiles.contacts.title',
    descriptionKey: 'tiles.contacts.description',
    route: '/contacts',
    icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z',
  },
  {
    key: 'family',
    titleKey: 'tiles.family.title',
    descriptionKey: 'tiles.family.description',
    route: '/family',
