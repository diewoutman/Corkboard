...
/** The "Step N of 3 — Set up Corkboard" breadcrumb + title + description atop each first-run wizard page. */
@Component({
  selector: 'app-setup-step-header',
  standalone: true,
  template: `
    <p class="text-sm font-bold text-ink-muted">Step {{ step }} of {{ totalSteps }} — Set up Corkboard</p>
